...
st.title("SuperKart Sales Price Prediction")
...
product_mrp  = st.number_input("Product MRP", min_value=0.0, step=0.01, value=150.00)
store_age_years  = st.number_input("Store Age (Years)", min_value=1, step=1, value=15)
